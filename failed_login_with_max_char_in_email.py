...
driver.find_element_by_xpath("/html/body/div/div[2]/form/input[1]").send_keys('coba.cobaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa@yahoo.com')
time.sleep(1)
